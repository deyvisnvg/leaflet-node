...
const engine = require('ejs-mate'); //Derivado de Websocket
...
//Esto sirve para que ahora desde cualquier archivo de nuestras vistas nosotros simplemente vamos a llamar la carpeta 'css' y podemos acceder a todos los archivos de adentro
